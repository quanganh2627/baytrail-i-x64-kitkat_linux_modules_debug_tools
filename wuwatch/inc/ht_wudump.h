...
typedef struct userwakelock_data userwakelock_data_t;
typedef std::vector<userwakelock_data_t> u_sample_vec_t;
typedef std::map<uint32_t, std::string> pkgmap_sample_map_t;
...
class HTWudump {
    private:
        ...
        /*
         * Hold Kernel Wakelock sample info.
         */
        w_sample_vec_t m_w_sample_vec;
        /*
         * Hold User Wakelock sample info.
         */
        u_sample_vec_t m_u_sample_vec;
        /*
         * Map to hold UID <-> Package Name mappings.
         */
        pkgmap_sample_map_t m_pkgmap_sample_map;
        /*
         * (Per-core) List of C-state samples to output.
         */
        sample_vec_t *m_per_cpu_c_state_samples;
        /*
         * (Per-package) List of PACKAGE C-state samples to output.
         */
        sample_vec_t *m_per_package_c_state_samples;
        /*
        ...
        /*
         * What version of the hook library were we using?
         */
        ...
        /*
         * Flag to indicate whether we should dump some
         * simple collection statistics (# samples, # dropped etc.)
         */
        ...
        /*
         * Should we output C-state residencies in clock ticks, instead of micro seconds?
         */
        bool m_do_c_res_in_clock_ticks;
        /*
        ...
        friend std::ostream& operator<<(std::ostream& os, const PWCollector_sample_t& sample);
        friend struct PerCoreCDumper;
        friend struct PerCorePDumper;

    private:
        int do_parse_i();
        int do_write_i();

        uint32_t getNumberOfDevices(device_type_t);
