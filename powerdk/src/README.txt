==============================================================================
           HOW TO BUILD AND LOAD THE PWR KERNEL DRIVER UNDER LINUX*
==============================================================================
...
to build and load the PWR kernel driver on the Linux* operating system.
...
must be present on the target system.
  ...
  Linux Distributions Based on Kernel 2.6
    ...
    * Red Hat Fedora* Core 12 and later:
...
The power analysis driver does not currently work on systems that have
