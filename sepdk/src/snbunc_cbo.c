...
/*!
 * @fn          static VOID snbunc_cbo_Write_PMU(VOID*)
 * 
...
)
{
    ...
    FOR_EACH_REG_ENTRY_UNC(pecb_unc, dev_idx, i) {
         ...
         */
        if (ECB_entries_reg_id(pecb_unc,i) == CBO_PERF_GLOBAL_CTRL) {
...
#if defined(MYDEBUG)
        SEP_PRINT_DEBUG("snbunc_cbo_Write_PMU Event_Data_reg = 0x%x --- value 0x%llx\n",
...
/*!
 * @fn         static VOID snbunc_cbo_Disable_PMU(PVOID)
 * 
...
/*!
 * @fn         static VOID snbunc_cbo_Enable_PMU(PVOID)
 * 
...
/*!
 * @fn         static VOID snbunc_cbo_Read_PMU_Data(PVOID)
 *
...
/*!
 * @fn         static VOID snbunc_cbo_Clean_Up(PVOID)
 *
...
/* ------------------------------------------------------------------------- */
/*!
 * @fn snbunc_cbo_Read_Counts(param, id)
 *
...
DISPATCH_NODE  snbunc_cbo_dispatch =
{
    NULL,                        // initialize
    NULL,                        // destroy
    snbunc_cbo_Write_PMU,        // write
    snbunc_cbo_Disable_PMU,      // freeze
    snbunc_cbo_Enable_PMU,       // restart
    NULL,                        // reinit
    snbunc_cbo_Read_PMU_Data,    // read
