...
/*!
 * @fn          static VOID wsmexunc_wbox_Write_PMU(VOID*)
 * 
...
)
{
    ...
    FOR_EACH_REG_ENTRY_UNC(pecb_unc, dev_idx, i) {
         ...
         * Disable counting
         */
        if (ECB_entries_reg_id(pecb_unc,i) == WBOX_PERF_GLOBAL_CTRL) {
            SYS_Write_MSR(ECB_entries_reg_id(pecb_unc,i), (long long)WBOX_GLOBAL_DISABLE);
            continue;
        }

        SYS_Write_MSR(ECB_entries_reg_id(pecb_unc,i), (0LL | ECB_entries_reg_value(pecb_unc,i)));
#if defined(MYDEBUG)
        SEP_PRINT_DEBUG("wsmexunc_wbox_Write_PMU Event_Data_reg = 0x%x --- value 0x%llx\n",
			ECB_entries_reg_id(pecb_unc,i), SYS_Read_MSR(ECB_entries_reg_id(pecb_unc,i)));
#endif
...
/*!
 * @fn         static VOID wsmexunc_wbox_Disable_PMU(PVOID)
 * 
...
/*!
 * @fn         static VOID wsmexunc_wbox_Enable_PMU(PVOID)
 * 
...
/*!
 * @fn         static VOID wsmexunc_wbox_Read_PMU_Data(PVOID)
 *
...
/*!
 * @fn         static VOID wsmexunc_wbox_Clean_Up(PVOID)
 *
...
/* ------------------------------------------------------------------------- */
/*!
 * @fn wsmexunc_wbox_Read_Counts(param, id)
 *
...
DISPATCH_NODE  wsmexunc_wbox_dispatch =
{
    NULL,                         // initialize
    NULL,                         // destroy
    wsmexunc_wbox_Write_PMU,      // write
    wsmexunc_wbox_Disable_PMU,    // freeze
    wsmexunc_wbox_Enable_PMU,     // restart
    NULL,                         // reinit
    wsmexunc_wbox_Read_PMU_Data,  // read
